...
export const settingsRegistry = {
  ...
  'ai.gemini_api_key': defineSetting({
    ...
    sensitive: true,
    workspaceOverrideAllowed: true,
    description: 'Custom Gemini API Key.',
  }),
  'ai.openai_api_key': defineSetting({
  ...
  'ai.openrouter_api_key': defineSetting({
    ...
    sensitive: true,
    workspaceOverrideAllowed: true,
    description: 'Custom OpenRouter API Key.',
  }),
