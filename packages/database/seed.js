...
async function main() {
  ...
  await prisma.facebookPageConnection.create({
    data: {
      ...
      grantedScopesJson: ['pages_show_list', 'pages_manage_metadata', 'pages_manage_posts', 'pages_read_engagement'],
  ...
  const sources = [
    ...
    },
    {
      ...
      feedUrl: 'https://congbao.chinhphu.vn/cac-van-ban-moi-ban-hanh.rss',
      sourceType: 'OFFICIAL_RSS',
      language: 'vi',
      country: 'VN',
      category: 'government',
